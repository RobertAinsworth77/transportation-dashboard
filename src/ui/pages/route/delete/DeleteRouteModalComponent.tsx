import './DeleteRouteModalStyles.scss';
...
import DeleteRouteModalComponentProps from './DeleteRouteModalComponentProps';

const DeleteRouteModalComponent: FC<DeleteRouteModalComponentProps> = ({ done }) => {
  ...
  return <div className="delete_route_modal_component">
    <form onSubmit={handleSubmit(_handleDelete)}>
      <div className="row">
        <div className={`col-12 form-group ${errors.confirm ? 'error' : ''}`}>
          <label>{i18n(KeyWordLocalization.DeleteRouteDescription)}</label>
          ...
          }))} className="form-control my-2" placeholder={i18n(KeyWordLocalization.DeleteRoutePlaceholder)} />
...
export default DeleteRouteModalComponent;
