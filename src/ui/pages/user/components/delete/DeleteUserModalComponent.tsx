import './DeleteUserModalStyles.scss';
...
import DeleteUserModalComponentProps from './DeleteUserModalComponentProps';

const DeleteUserModalComponent: FC<DeleteUserModalComponentProps> = ({ done }) => {
  ...
  return <div className="delete_user_modal_component">
    <form onSubmit={handleSubmit(_handleDelete)}>
      <div className="row">
        <div className={`col-12 form-group ${errors.confirm ? 'error' : ''}`}>
          <label>{i18n(KeyWordLocalization.DeleteUserDescription)}</label>
          ...
          }))} className="form-control my-2" placeholder={i18n(KeyWordLocalization.DeleteUserPlaceholder)} />
